...
source("~/Documents/BreedStream_App/BreedStream_Panels/Cleaning.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/Format.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/insilico.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/TwoStage.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/Index.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/Effects.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/UC.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/OMA.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/TransposedPredict.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/Transposedinsilico.R")
source("~/Documents/BreedStream_App/BreedStream_Panels/QualityCheck.R")
